...
write("<table id=tblCoolbar border='0' bgcolor='#6699CC'>");
write("<TR>");
...
write("&nbsp;&nbsp;<select name='tbSelMonth' onChange='fUpdateCal(tbSelYear.value, tbSelMonth.value)' Victor='Won' style='width: 72px' onclick='self.event.cancelBubble=true' onblur='fHideCal()'>");
for (i=0; i<12; i++)
	write("<option value='"+(i+1)+"'>"+gMonths[i]+"</option>");
write("</SELECT>");
write("&nbsp;&nbsp;<SELECT name='tbSelYear' onChange='fUpdateCal(tbSelYear.value, tbSelMonth.value)' Victor='Won' style='width: 70px'  onclick='self.event.cancelBubble=true' onblur='fHideCal()'>");
for(i=giYear-3;i<giYear+3;i++)
