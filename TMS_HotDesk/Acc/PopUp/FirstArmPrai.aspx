<%@ Page Language="C#" AutoEventWireup="false" CodeFile="FirstArmPrai.aspx.cs" Inherits="Acc_PopUp_FirstArmPrai" %>
...
<%--			
		            	...
		            	<asp:BoundField  HeaderText="STAFF NAME" DataField="STAFFNAME" ControlStyle-Width="30%"> 
                            <HeaderStyle HorizontalAlign="center" VerticalAlign="Middle"></HeaderStyle>
                            <ItemStyle HorizontalAlign="left" VerticalAlign="Middle" />
                        </asp:BoundField>
			
		            	<asp:BoundField  HeaderText="FIRST SCAN" DataField="TRANSTIME" ControlStyle-Width="30%"> 
                            <HeaderStyle HorizontalAlign="center" VerticalAlign="Middle"></HeaderStyle>
                            <ItemStyle HorizontalAlign="left" VerticalAlign="Middle" />
                        </asp:BoundField>
		            	...
		            	<asp:BoundField  HeaderText="DATE" DataField="Transdate" ControlStyle-Width="20%"> 
                            <HeaderStyle HorizontalAlign="center" VerticalAlign="Middle"></HeaderStyle>
                            <ItemStyle HorizontalAlign="left" VerticalAlign="Middle" />
                        </asp:BoundField>
			
                        <asp:BoundField  HeaderText="DOOR" DataField="DOOR" ControlStyle-Width="20%">
                            <HeaderStyle HorizontalAlign="center" VerticalAlign="Middle"></HeaderStyle>
                            <ItemStyle HorizontalAlign="left" VerticalAlign="Middle" />
                        </asp:BoundField>
                    </Columns>
