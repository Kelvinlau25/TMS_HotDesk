<%@ Page Language="C#" AutoEventWireup="false" CodeFile="LastArmPrai.aspx.cs" Inherits="Acc_PopUp_LastArmPrai" %>
...
<%--			
		            	...
		            	<asp:BoundField  HeaderText="LAST SCAN" DataField="TRANSTIME" ControlStyle-Width="30%"> 
                            <HeaderStyle HorizontalAlign="center" VerticalAlign="Middle"></HeaderStyle>
                            <ItemStyle HorizontalAlign="left" VerticalAlign="Middle" />
                        </asp:BoundField>
