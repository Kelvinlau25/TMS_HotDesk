<%@ Page Language="C#" MasterPageFile="~/master/Main.master" AutoEventWireup="false" CodeFile="ListSpice.aspx.cs" Inherits="Acc_PopUp_ListSpice" title="Check In List" %>
...
<script type="text/javascript">
    function passvalue(staffID,staffName) {
        window.opener.$('.<%= _staffID %>').val(staffID);
        window.opener.$('.<%= _staffName %>').val(staffName);
        // Close the popup
        window.close();
    }
