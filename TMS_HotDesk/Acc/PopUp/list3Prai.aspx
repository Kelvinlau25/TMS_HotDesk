<%@ Page Language="C#" AutoEventWireup="false" CodeFile="list3Prai.aspx.cs" Inherits="Acc_PopUp_list3Prai" %>
    ...
    <div class="wrap hidedrop">
        <div class="dropdown">
            <div id="subdrop1" class="dropdown-content4 dc" >
                <div style="" >
                        <iframe src="FirstArmPrai.aspx"  clASS="map1 map2" id="Iframe2" runat="server"></iframe>
       
                </div>
            </div>
            <div id="subdrop2" class="dropdown-content4 dc" >
                <div style="" >
                        <iframe src="LastArmPrai.aspx"  clASS="map1 map2" id="Iframe1" runat="server"></iframe>
