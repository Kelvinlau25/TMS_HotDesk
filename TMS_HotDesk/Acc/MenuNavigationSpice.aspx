<%@ Page Language="C#" MasterPageFile="~/master/Main.master" AutoEventWireup="false" CodeFile="MenuNavigationSpice.aspx.cs" Inherits="Acc_MenuNavigationSpice" title="TMS Check In" %>
    ...
    <script type="text/javascript">
        ...
        function popupwindow(ID, Name) {
            if( document.getElementById('<%=txtStaffName.ClientID%>').value == "") {
                ...
                popupWindow = window.open('<%= ResolveUrl("~/acc/PopUp/ListSpice.aspx") %>?itm1=' + ID + '&itm2=' + Name,'PopUp', 'directories=no,titlebar=no,toolbar=no,location=no,status=no,menubar=no,scrollbars=yes,resizable=no,width=800,height=600,top='+top+', left='+left +'');
            }
            else {  
    ...
    <script type="text/javascript">
        $(document).ready(function() {
            ...
            $("#checkInList2").click(function() {
                document.getElementById("<%= Iframe2.ClientID %>").src = 'PopUp/list3Spice.aspx';
                document.getElementById("warehouse1").style.backgroundColor = "BLACK";
                document.getElementById("warehouse2").style.backgroundColor = "BLACK"; 
                document.getElementById("checkInList").style.backgroundColor = "BLACK";   
        ...
        <div class="wrap hidedrop">
            <div class="dropdown">
                ...
                <div id="dropdowncontent1" class="dropdown-content dc" style="border-color:red;border:solid 5px solid red">
                    ...
                    <asp:Image ID="Image1" runat="server" ImageUrl="~/Acc/leftSpice.png" UseMap="#simple" CssClass="map" />
...
<area alt="" title=""  shape="poly" id="map29"  coords="459,906,457,955,494,955,517,946,539,955,570,954,569,906,513,895" />
                ...
                <div id="dropdowncontent4" class="dropdown-content4 dc" >
                    <div style="" >
                        <iframe src="PopUp/list3Spice.aspx"  clASS="map1" id="Iframe2" runat="server"></iframe>
                        <div class="desc"><a href="#"></a></div>
                    </div>
                </div>
            </div>
