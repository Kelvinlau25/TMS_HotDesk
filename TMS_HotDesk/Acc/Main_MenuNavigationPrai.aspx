<%@ Page Language="C#" MasterPageFile="~/master/Main.master" AutoEventWireup="false" CodeFile="Main_MenuNavigationPrai.aspx.cs" Inherits="Acc_Main_MenuNavigationPrai" title="TMS PRAI Hot Desking Home Page" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    <iframe runat="server" src="MenuNavigationPrai.aspx" id="ifrm" height="1150px" width="100%" scrolling="no" />
<div class="footer">
