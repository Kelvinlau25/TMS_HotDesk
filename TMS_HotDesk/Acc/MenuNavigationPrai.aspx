<%@ Page Language="C#" MasterPageFile="~/master/Main.master" AutoEventWireup="false" CodeFile="MenuNavigationPrai.aspx.cs" Inherits="Acc_MenuNavigationPrai" title="TMS Check In" %>
...
<script type="text/javascript">
  ...
  function popupwindow(ID, Name) {
     if( document.getElementById('<%=txtStaffName.ClientID%>').value == "")
     {
        ...
        popupWindow = window.open('<%= ResolveUrl("~/acc/PopUp/ListPrai.aspx") %>?itm1=' + ID + '&itm2=' + Name,'PopUp', 'directories=no,titlebar=no,toolbar=no,location=no,status=no,menubar=no,scrollbars=yes,resizable=no,width=800,height=600,top='+top+', left='+left +'');
...
document.getElementById("warehouse1").style.backgroundColor = "BLUE";
	...
	document.getElementById("<%= Iframe2.ClientID %>").src = 'PopUp/list3Prai.aspx';
        document.getElementById("warehouse1").style.backgroundColor = "BLACK";
        document.getElementById("warehouse2").style.backgroundColor = "BLACK"; 
        document.getElementById("warehouse3").style.backgroundColor = "BLACK";  
        document.getElementById("checkInList").style.backgroundColor = "BLACK";  
...
<link href="../css_new/TMSAccessPrai.css" rel="stylesheet" type="text/css" />
...
<area alt="" title="" shape="rect" id="map76" coords="592,510,528,402" /> <%--14c--%><%--New--%>
          ...
          <div id="dropdowncontent4" class="dropdown-content4 dc" >
            ...
            <div style="" >
                    <iframe src="PopUp/list3Prai.aspx"  clASS="map1" id="Iframe2" runat="server"></iframe>
                    <div class="desc"><a href="#"></a></div>
            </div>
          </div>
        </div>
