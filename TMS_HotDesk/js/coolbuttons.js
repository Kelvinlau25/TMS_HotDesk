...
//buttonface 4169E1 1E90FF
document.write("<style>");
document.write(".coolBar	{background: #4169E1;border-top: 1px solid buttonhighlight;	border-left: 1px solid buttonhighlight;	border-bottom: 1px solid buttonshadow; border-right: 1px solid buttonshadow; padding: 2px; font: menu;}");
